...
vim.keymap.set('n', '<leader>fh', function () _CallTelescope(_builtin.help_tags) end, { desc = 'List help tags' })
vim.keymap.set('n', '<leader>fs', function () _CallTelescope(_builtin.lsp_document_symbols) end, { desc = 'List LSP document symbols' })
vim.keymap.set('n', '<leader>fr', function () _CallTelescope(_builtin.lsp_references) end, { desc = 'List LSP references' })
...
vim.keymap.set('n', '<leader>fd', function () _CallTelescope(_builtin.diagnostics, {bufnr=0}) end, { desc = 'List Diagnostics for current buffer' })
vim.keymap.set('n', '<leader>fD', function () _CallTelescope(_builtin.diagnostics) end, { desc = 'List All Diagnostics' })
vim.keymap.set('n', '<leader>fi', function () _CallTelescope(_builtin.lsp_implementations) end, { desc = 'List LSP implementations' })
